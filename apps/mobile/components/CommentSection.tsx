      ...
      {user ? (
        <View style={styles.inputRow}>
          <TextInput
            ...
            multiline
          />
          <Pressable style={[styles.sendButton, !text.trim() && styles.sendDisabled]} onPress={handleSubmit} disabled={!text.trim() || submitting}>
...
const styles = StyleSheet.create({
  ...
  inputRow: { flexDirection: "row", alignItems: "flex-end", padding: 12, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "#333" },
  input: { flex: 1, color: "#fff", fontSize: 14, backgroundColor: "#1a1a1a", borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, maxHeight: 80 },
  sendButton: { marginLeft: 8, backgroundColor: "#8B5CF6", borderRadius: 8, paddingHorizontal: 16, paddingVertical: 10 },
